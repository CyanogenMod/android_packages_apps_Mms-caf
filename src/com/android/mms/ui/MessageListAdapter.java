...
public class MessageListAdapter extends CursorAdapter {
    ...
    public MessageListAdapter(
        ...
        int msgBubbleMargin = context.getResources()
                .getDimensionPixelSize(R.dimen.recv_message_bubble_layout_margin_start);
        int maxItemWidth = mListView.getWidth() - msgBubbleMargin;
        mMessageCache.setMaxItemWidth(maxItemWidth);
    }
    ...
    public int getItemViewType(int position) {
        ...
        if (!isMmsMsgType(type)) {
            ...
            long msgId = cursor.getLong(mColumnsMap.mColumnMsgId);
            String[] mimeTypes = mMessageCache.getCachedMimeTypes(msgId);
            if (mimeTypes != null) {
