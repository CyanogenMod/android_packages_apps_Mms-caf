...
public class ConversationListItem extends RelativeLayout implements Contact.UpdateListener,
    ...
    private void updateAvatarView(LookupResponse lookupResponse) {
        // for pluggable providers, lookupResponse will not be null, so it's handled first
        ...
        // not pluggable provider contact, setContactUri() to null so that onClick() is processed
