...
public class MSimSpinnerAdapter extends ResourceCursorAdapter {
    ...
    private static final RelativeSizeSpan PREFIX_SPAN = new RelativeSizeSpan(0.7f);
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        if (slotIndex >= 0) {
            ...
            final String prefix = mContext.getString(R.string.sim_spinner_active_item_prefix,
                    slotIndex + 1);
            builder.append("  ");
            builder.append(prefix, PREFIX_SPAN, 0);
