...
public abstract class AttachmentView extends RelativeLayout implements SlideViewInterface {
    ...
    public SlideModel mSlide;
    private View mRoot;
    private Handler mHandler;
    private ViewGroup mThumbnailRoot;
...
//        });
//
//        mThumbnailRoot = (ViewGroup) mRoot.findViewById(R.id.thumbnail_root);
//        mThumbnailRoot.setOnClickListener(new OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                if (mHandler != null) {
...
//            }
//        });
        setupView(mThumbnailRoot);
    }

    public ViewGroup getThumbnailRoot() {
        return mThumbnailRoot;
    }
