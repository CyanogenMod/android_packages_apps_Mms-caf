...
public class MessagingPreferenceActivity extends PreferenceActivity
    ...
    private class BackupRestoreSMSTask extends AsyncTask<Void, Void, File> {
        ...
        public BackupRestoreSMSTask(boolean shouldBackup) {
            mShouldBackup = shouldBackup;
        }

        public BackupRestoreSMSTask(File restoreFile, boolean shouldBackup) {
        ...
        protected void onPreExecute() {
            String title = getString(mShouldBackup ? R.string.perform_backup_title : R.string.perform_restore_title);
        ...
        protected void onPostExecute(final File file) {
            ...
            if (mShouldBackup) {
                ...
                builder.setMessage(R.string.export_sms_toast)
                        .setMessage(String.format(getString(R.string.backup_file_name_message, file.getAbsolutePath())))
                        .setPositiveButton(android.R.string.ok, null)
                        .setNegativeButton(R.string.message_share, new DialogInterface.OnClickListener() {
    ...
    private class RestoreDeleteListFilesTask extends AsyncTask<Void, Void, File[]> {
        ...
        public RestoreDeleteListFilesTask(boolean shouldRestore) {
            mShouldDelete = shouldRestore;
        }
                    ...
                    .setAdapter(adapter, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            if (mShouldDelete) {
                                ...
                                new BackupRestoreSMSTask(adapter.getFile(which), false).execute();
                            }
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which) {
                    case SMS_IMPORT:
                        ...
                        break;
                    case SMS_EXPORT:
                        new BackupRestoreSMSTask(true).execute();
                        break;
                    case SMS_DELETE:
