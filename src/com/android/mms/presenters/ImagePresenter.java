...
public class ImagePresenter extends ThumbnailPresenter<ImageMessageView, ImagePresenterModel> {
    ...
    @Override
    public ImageMessageView getView(PresenterOptions presenterOptions) {
    ...
    @Override
    public ImageMessageView getAttachmentView(AttachmentPresenterOptions presenterOptions) {
        ImageMessageView view = new ImageMessageView(getContext());
        view.setAdjustViewBounds(true);
        ViewGroup.MarginLayoutParams layoutParams = new ViewGroup.MarginLayoutParams(
                ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
