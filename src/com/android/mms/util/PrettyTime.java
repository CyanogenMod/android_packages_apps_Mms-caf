...
public class PrettyTime {
    ...
    // private synchronized initializeBuffers()
    ...
    public static boolean isWithinSameDay(long millis1, long millis2) {
        ...
        sCalendar.setTimeInMillis(millis1);
        int date1 = 0;
        date1 += sCalendar.get(Calendar.DAY_OF_MONTH);
        date1 = date1 << 4;
        date1 += sCalendar.get(Calendar.DAY_OF_MONTH);
        date1 = date1 << 12;
        date1 += sCalendar.get(Calendar.YEAR);

        sCalendar.setTimeInMillis(millis2);
        int date2 = 0;
        date2 += sCalendar.get(Calendar.DAY_OF_MONTH);
        date2 = date2 << 4;
        date2 += sCalendar.get(Calendar.DAY_OF_MONTH);
        date2 = date2 << 12;
        date2 += sCalendar.get(Calendar.YEAR);
