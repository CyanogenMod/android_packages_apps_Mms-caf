...
public class MetricsHelper {
    ...
    private static final String CATEGORY_BASE = "mmsnext.callerinfo.";
    ...
    public enum State {
        FIRST_LAUNCH_DIALER("first_launch_mms"),
    ...
    public static void init(MmsApp context) {
    ...
    private AmbientApiClient getClient() {
        if (mClient == null) {
            ...
            mClient = new AmbientApiClient.Builder(mContext)
    ...
    public static void sendEvent(Categories category, Actions action, State state, Field... fields) {
