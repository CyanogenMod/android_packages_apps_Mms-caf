...
public class QuickMessagePopup extends Activity {
    ...
    private class MessagePagerAdapter extends PagerAdapter
        ...
        public Object instantiateItem(ViewGroup view, int position) {
            ...
            final View layout = LayoutInflater.from(QuickMessagePopup.this)
            ...
            final LayeredImageButton qmSendButton =
                    (LayeredImageButton) layout.findViewById(R.id.send_button);
            ...
            final View messageBlock = layout.findViewById(R.id.message_block_area);
            final View messageBubbleArrowhead = layout.findViewById(R.id.message_bubble_arrowhead);
            ...
            final String fromNumber = qm.getFromNumber()[0];
            updateContactBadge(qmContactBadge, fromNumber, false);
            ...
            MessageUtils.tintBackground(messageBlock, themeColor);
            MessageUtils.tintBackground(messageBubbleArrowhead, themeColor);
            ...
            SchedulingUtils.doAfterLayout(layout, new Runnable() {
                @Override
                public void run() {
                    mSendButtonContactImageTask = new AsyncTask<Void, Void, Pair<Contact, Contact>>() {
                            @Override
                            protected Pair<Contact, Contact> doInBackground(Void... params) {
                                Contact fromContact = Contact.get(fromNumber, true);
                                fromContact.getAccentColor(QuickMessagePopup.this, true);
                                return new Pair<>(Contact.getMe(true), fromContact);
                            }

                            @Override
                            protected void onPostExecute(Pair<Contact, Contact> contactPair) {
                                Contact self = contactPair.first;
                                self.getBitmap(QuickMessagePopup.this, qmSendButton.getWidth(),
                                ...
                                Contact fromContact = contactPair.second;
                                int contactAccentColor = fromContact.getAccentColor(QuickMessagePopup.this, false);
                                int mappedColor = MessageUtils.getMappedMaterialColor(getResources(), contactAccentColor);
                                MessageUtils.tintBackground(messageBlock, mappedColor);
                                MessageUtils.tintBackground(messageBubbleArrowhead, mappedColor);
                            }
