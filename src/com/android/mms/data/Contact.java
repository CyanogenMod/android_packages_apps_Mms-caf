...
public class Contact {
    ...
    public synchronized void getBitmap(Context context, int sizeHint, final BitmapRequestCallback cb) {
        // image view is the sentinel used to track the request in the ContactPhotoManager
