...
public class PhoneNumber implements Comparable<PhoneNumber> {
     ...
     */
    public static ArrayList<PhoneNumber> getPhoneNumbers(Context context, ContactsPreferences contactsPreferences) {
        ...
        final Uri uri = Phone.CONTENT_URI.buildUpon()
                .appendQueryParameter(ContactCounts.EXTRA_ADDRESS_BOOK_INDEX, "true").build();
