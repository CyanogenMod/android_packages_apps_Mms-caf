...
System.out.println("getDocument took " + (System.currentTimeMillis() - cur));
        ...
        System.out.println("iter smilregion took " + (System.currentTimeMillis() - cur));
...
//            if (mediaNum == 0) {
//                SlideModel slide = new SlideModel((int) (par.getDur() * 1000), new ArrayList<MediaModel>(mediaNum));
//                slide.setFill(par.getFill());
//                SmilHelper.addParElementEventListeners((EventTarget) par, slide);
//                slides.add(slide);
//            }
        }
        System.out.println("slides iter took " + (System.currentTimeMillis() - cur));
    ...
    */
    ...
    public Presenter getPresenter() {
        if (isSimple()) {
            ...
            SlideModel firstModel = get(0);
            return firstModel.getPresenter();
        } else {
            ...
            return new Presenter(mContext, null) {
                ...
                public void present(ViewGroup v, int accentColor) {
                    ...
                    for (SlideModel i : SlideshowModel.this) {
                        LinearLayout container = new LinearLayout(mContext);
                        container.setBackgroundColor(Color.RED);
                        if (i.get(0).getPresenter() != null) {
                            i.get(0).getPresenter().present(container, accentColor);
                        }
