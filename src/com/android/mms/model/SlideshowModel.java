...
public class SlideshowModel extends Model
    ...
    public static SlideshowModel createFromMessageUri(
        ...
        return createFromPduBody(context, getPduBody(context, uri), uri.getLastPathSegment());
    }

    public static SlideshowModel createFromPduBody(Context context, PduBody pb, String id) throws MmsException {
...
//            }
        ...
        SlideshowModel slideshow = new SlideshowModel(layouts, slides, document, pb, context, id);
